...
close all;
clc;
nums=20;    %处理的图片数，也是横坐标
%% 导入excel数据
NSCT_t=readtable('F:\论文整理构思\评价指标\傅羽\DATA\方法对比\mri-pet\NSCT\第一篇\每张图片指标.xlsx','range','B1:AD21'); %要把标题行读进去，不然会把第一行当数据
LES_t=readtable('F:\论文整理构思\评价指标\傅羽\DATA\方法对比\mri-pet\LES\第一篇\每张图片指标.xlsx','range','B1:AD21');
MSTSR_t=readtable('F:\论文整理构思\评价指标\傅羽\DATA\方法对比\mri-pet\MSTSR\第一篇\每张图片指标.xlsx','range','B1:AD21');
CNN_t=readtable('F:\论文整理构思\评价指标\傅羽\DATA\方法对比\mri-pet\CNN\第一篇\每张图片指标.xlsx','range','B1:AD21');
IFCNN_t=readtable('F:\论文整理构思\评价指标\傅羽\DATA\方法对比\mri-pet\IFCNN\第一篇\每张图片指标.xlsx','range','B1:AD21');
DSAGAN_t=readtable('F:\论文整理构思\评价指标\傅羽\DATA\方法对比\mri-pet\DSAGAN\第一篇\每张图片指标.xlsx','range','B1:AD21');
EMFusion_t=readtable('F:\论文整理构思\评价指标\傅羽\DATA\方法对比\mri-pet\EMFusion\第一篇\每张图片指标.xlsx','range','B1:AD21');
% D2FNet_t=readtable('F:\论文整理构思\评价指标\傅羽\DATA\方法对比\mri-pet\D2FNet\第一篇\每张图片指标.xlsx','range','B1:AD21');
D2FNet_t=readtable('F:\论文整理构思\评价指标\傅羽\DATA\方法对比\mri-pet\wgif-D2FNet\第一篇\每张图片指标.xlsx','range','B1:AD21');
...
legend('D2FNet:0.7971','NSCT:0.7580','LES:0.7768','MSTSR:0.7702','CNN:0.7365','IFCNN:0.7872','DSAGAN:0.3649','EMFusion:0.7914','Location','northeast','Orientation','horizontal','NumColumns',3,'Box','off');                        %图例与画线的先后顺序一致,这里顺便把均值加上去
set(gca,'YLim',[0.1,1.2]);     %设置y的上限值
...
legend('D2FNet:0.8605','NSCT:0.8494','LES:0.8575','MSTSR:0.8534','CNN:0.8606','IFCNN:0.8582','DSAGAN:0.8586','EMFusion:0.8602','Location','northeast','Orientation','horizontal','NumColumns',3,'Box','off'); 
set(gca,'YLim',[0.75,1.0]);
set(gca,'ytick',[0.75:0.05:1.0]);
...
legend('D2FNet:19.3116','NSCT:15.9459','LES:15.8628','MSTSR:16.5910','CNN:16.2885','IFCNN:16.4796','DSAGAN:15.9344','EMFusion:17.7876','Location','north','Orientation','horizontal','NumColumns',3,'Box','off'); 
set(gca,'YLim',[14.0,24.0]);
set(gca,'ytick',[14.0:1.5:24.0]);
...
legend('D2FNet:0.6843','NSCT:0.6664','LES:0.6454','MSTSR:0.6623','CNN:0.5524','IFCNN:0.6669','DSAGAN:0.3413','EMFusion:0.6675','Location','northeast','Orientation','horizontal','NumColumns',3,'Box','off');
set(gca,'YLim',[0.2,1]);
...
legend('D2FNet:0.9085','NSCT:0.8224','LES:0.8689','MSTSR:0.8490','CNN:0.8374','IFCNN:0.9192','DSAGAN:0.4407','EMFusion:0.8890','Location','northeast','Orientation','horizontal','NumColumns',3,'Box','off');
...
legend('D2FNet:0.6665','NSCT:0.3887','LES:0.4223','MSTSR:0.4590','CNN:0.4430','IFCNN:0.4694','DSAGAN:0.3520','EMFusion:0.6503','Location','northeast','Orientation','horizontal','NumColumns',3,'Box','off');
set(gca,'YLim',[0.2,1.0]);
