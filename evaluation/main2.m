...
% 
% %%% 方法间比较
% fusion_name={'LES','NSCT','MSTSR','CNN','DSAGAN','IFCNN','EMFusion','SR','DWT','D2FNet'};
% nums=30;
% 
% 
...
% disp(name);
% %%% 方法间比较
% % fused_path = strcat('./DATA/方法对比/mri-ct/',name,'/第二篇/');
% % fused_path = strcat('./DATA/方法对比/mri-pet/',name,'/第二篇/');
% fused_path = strcat('./DATA/方法对比/mri-spect/',name,'/第二篇/');
...
%     for i =1:1:nums
% %         %读取源图像对
% %         source_ir  = ['E:/论文写作/杨老师/论文投稿/CCF(EI)/第二篇文章/材料/检验图片/mri-ct/mri/',num2str(i),'.png'];
% %         source_vis = ['E:/论文写作/杨老师/论文投稿/CCF(EI)/第二篇文章/材料/检验图片/mri-ct/ct/',num2str(i),'.png'];
% %         source_ir  = ['E:/论文写作/杨老师/论文投稿/CCF(EI)/第二篇文章/材料/检验图片/mri-pet/mri/',num2str(i),'.png'];
% %         source_vis = ['E:/论文写作/杨老师/论文投稿/CCF(EI)/第二篇文章/材料/检验图片/mri-pet/pet/',num2str(i),'.png'];
%         source_ir  = ['E:/论文写作/杨老师/论文投稿/CCF(EI)/第二篇文章/材料/检验图片/mri-spect/mri/',num2str(i),'.png'];
%         source_vis = ['E:/论文写作/杨老师/论文投稿/CCF(EI)/第二篇文章/材料/检验图片/mri-spect/spect/',num2str(i),'.png'];
%          
%         
...
%%% 方法间比较
fusion_name={'LES','NSCT','MSTSR','CNN','DSAGAN','IFCNN','EMFusion','MURF','MATR','DPCN','proposed'};
% nums=148;
nums=30;
...
disp(name);
%%% 方法间比较
fused_path = strcat('./DATA/方法对比/gfp-pci/',name,'/第三篇/');
if exist(fused_path)==0 %%判断文件夹是否存在
    mkdir(fused_path); 
end    
